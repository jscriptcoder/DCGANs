...
See [**Jupyer notebook**](https://github.com/jscriptcoder/DCGANs/blob/master/face_generation.ipynb) for details about this project, hyperparameters and algorithms used.
